...
public class InspectPrescribing8 extends CommonToAllTest {
    ...
    public void testSidebarFlow() {
        ...
        System.out.println("\n\n========== INSPECTING Expired Prescriptions via Sidebar ==========");
        
        try {
            WebElement link = getDriver().findElement(By.xpath("//a[@href='/prescribe-management/expired-prescriptions']"));
