...
/**
 * One-off discovery tool to inspect all Prescribing module pages.
 * NOT part of testng.xml — run manually with -Dtest=InspectPrescribing.
 */
public class InspectPrescribing extends CommonToAllTest {
    ...
    public void inspectAllPrescribingPages() {
        ...
        inspectPage("https://qc.care-connect.health/prescribe-management/authorization-list", "Prescribe Auth");
