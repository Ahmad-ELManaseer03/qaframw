...
public class ConfigurationsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/configurations']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'CDSS Configuration Management')]");

    public ConfigurationsPage navigateToConfigurations() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Configurations: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/configurations");
    }
}
