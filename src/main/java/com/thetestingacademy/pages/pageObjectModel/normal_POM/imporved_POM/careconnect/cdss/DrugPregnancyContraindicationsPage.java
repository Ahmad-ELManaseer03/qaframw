...
public class DrugPregnancyContraindicationsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugPregnancyContraindications']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Pregnancy Contraindications List')]");

    public DrugPregnancyContraindicationsPage navigateToDrugPregnancyContraindications() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Pregnancy Contraindications: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugPregnancyContraindications");
    }
}
