...
/**
 * FacilitiesPage — Page Object for the Organization > Facilities page.
 *
 * DOM Inspection Findings (2026-07-20):
 * - Page Header: <div class="panel-header ..."> Facilities </div>
 ...
 */
public class FacilitiesPage extends CommonToAllPage {
    ...
    @Step("Navigate directly to the Facilities page")
    public void navigateToFacilitiesPage() {
        ...
        getDriver().get("https://qc.care-connect.health/organization/facility");
    }
