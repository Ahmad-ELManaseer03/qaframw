...
public class DrugSmokingInteractionsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugSmokingInteractions']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Smoking Interactions List')]");

    public DrugSmokingInteractionsPage navigateToDrugSmokingInteractions() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Smoking Interactions: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugSmokingInteractions");
    }
}
