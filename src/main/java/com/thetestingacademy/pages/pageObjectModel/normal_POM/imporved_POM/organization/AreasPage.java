...
/**
 * AreasPage — Page Object for the Organization > Areas page.
 *
 * DOM Inspection Findings (2026-07-19):
 * - Page Header: <div class="panel-header ..."> Area List </div>
 ...
 */
public class AreasPage extends CommonToAllPage {
    ...
    @Step("Navigate directly to the Areas page")
    public void navigateToAreasPage() {
        ...
        getDriver().get("https://qc.care-connect.health/organization/area");
    }
