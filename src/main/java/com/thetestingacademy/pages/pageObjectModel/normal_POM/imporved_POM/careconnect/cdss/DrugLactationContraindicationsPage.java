...
public class DrugLactationContraindicationsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugLactationContraindications']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Lactation Contraindications List')]");

    public DrugLactationContraindicationsPage navigateToDrugLactationContraindications() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Lactation Contraindications: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugLactationContraindications");
    }
}
