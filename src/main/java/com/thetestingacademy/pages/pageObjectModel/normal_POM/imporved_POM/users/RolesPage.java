...
/**
 * RolesPage — Page Object for the Users > Roles page.
 *
 * DOM Inspection Findings:
 * - Page Header: <div class="panel-header ..."> Roles List </div>
 ...
 */
public class RolesPage extends CommonToAllPage {
    ...
    @Step("Navigate directly to the Roles page")
    public void navigateToRolesPage() {
        ...
        getDriver().get("https://qc.care-connect.health/role");
    }
