...
public class DrugAgeInteractionsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugAgeInteractions']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Age Interactions List')]");

    public DrugAgeInteractionsPage navigateToDrugAgeInteractions() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Age Interactions: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugAgeInteractions");
    }
}
