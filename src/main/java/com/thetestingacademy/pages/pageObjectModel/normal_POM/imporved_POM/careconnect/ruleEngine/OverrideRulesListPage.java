...
public class OverrideRulesListPage extends CommonToAllPage {

    // Locators
    private final By linkLoc = By.xpath("//a[@href='/rules-management/rules-override/workflows']");
    // Verify using page content (like a table header) rather than just the generic body
    private final By headerLoc = By.xpath("//h5[contains(., 'Override Rules List')] | //div[contains(@class, 'header')]//span[contains(text(), 'Override Rules List')] | //th[contains(., 'Rule ID')]");

    public OverrideRulesListPage navigateToOverrideRulesList() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Override Rules List: " + ex.getMessage());
            }
        }
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/rules-management/rules-override/workflows");
    }
}
