...
public class DrugDiagnosisContraindicationsPage extends CommonToAllPage {

    // Locators
    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugDiagnosisContraindications']");
    // Verify using page content
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Diagnosis Contraindications List')]");

    public DrugDiagnosisContraindicationsPage navigateToDrugDiagnosisContraindications() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Diagnosis Contraindications: " + ex.getMessage());
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugDiagnosisContraindications");
    }
}
