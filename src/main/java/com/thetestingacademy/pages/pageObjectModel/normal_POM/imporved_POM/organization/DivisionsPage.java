...
/**
 * DivisionsPage — Page Object for the Organization > Divisions page.
 *
 * DOM Inspection Findings:
 * - Page Header: <div class="panel-header ..."> Divisions </div>
 ...
 */
public class DivisionsPage extends CommonToAllPage {
    ...
    @Step("Navigate directly to the Divisions page")
    public void navigateToDivisionsPage() {
        ...
        getDriver().get("https://qc.care-connect.health/organization/division");
    }
