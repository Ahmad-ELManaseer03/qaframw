...
public class DrugGenderInteractionsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugGenderInteractions']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Gender Interactions List')]");

    public DrugGenderInteractionsPage navigateToDrugGenderInteractions() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Gender Interactions: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugGenderInteractions");
    }
}
