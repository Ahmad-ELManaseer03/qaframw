...
public class PrescribeAuthPage extends CommonToAllPage {

    @Step("Navigate to Prescribe Auth page and verify it loaded")
    public boolean isPrescribeAuthPageLoaded() {
        ...
        // Click sidebar link
        By linkLoc = By.xpath("//a[@href='/prescribe-management/authorization-list']");
        ...
        By pageHeader = By.xpath("//*[normalize-space(text())='Prescribe Authorizations List']");
        WaitHelpers.checkVisibility(getDriver(), pageHeader, 15);

        return getDriver().getCurrentUrl().contains("/prescribe-management/authorization-list");
    }
}
