...
public class DrugLabInteractionsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugLabInteractions']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Lab Interactions List')]");

    public DrugLabInteractionsPage navigateToDrugLabInteractions() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Lab Interactions: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugLabInteractions");
    }
}
