...
public class DrugFoodInteractionsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugFoodInteractions']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Food Interactions List')]");

    public DrugFoodInteractionsPage navigateToDrugFoodInteractions() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Food Interactions: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugFoodInteractions");
    }
}
