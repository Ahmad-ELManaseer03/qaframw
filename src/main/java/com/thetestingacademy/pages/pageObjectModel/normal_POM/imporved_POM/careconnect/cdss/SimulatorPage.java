...
public class SimulatorPage extends CommonToAllPage {
    ...
    private final By linkLoc = By.xpath("//a[@href='/cdss-management/simulator']");
    private final By headerLoc = By.xpath("//*[contains(., 'Simulation Input')]");
    ...
    public SimulatorPage navigateToSimulator() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click CDSS Simulator: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/simulator");
    }
}
