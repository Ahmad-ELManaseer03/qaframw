...
/**
 * UsersPage — Page Object for the Users > Users page.
 *
 * DOM Inspection Findings:
 * - Page Header: <div class="panel-header ..."> Users List </div>
 ...
 */
public class UsersPage extends CommonToAllPage {
    ...
    @Step("Navigate directly to the Users page")
    public void navigateToUsersPage() {
        ...
        getDriver().get("https://qc.care-connect.health/user");
    }
