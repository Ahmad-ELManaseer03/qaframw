...
/**
 * DistrictsPage — Page Object for the Organization > Districts page.
 *
 * DOM Inspection Findings (2026-07-19):
 * - Page Header: <div class="panel-header ..."> District List </div>
 ...
 */
public class DistrictsPage extends CommonToAllPage {
    ...
    @Step("Navigate directly to the Districts page")
    public void navigateToDistrictsPage() {
        ...
        getDriver().get("https://qc.care-connect.health/organization/district");
    }
