...
public class DrugDrugInteractionsPage extends CommonToAllPage {

    private final By linkLoc = By.xpath("//a[@href='/cdss-management/drugDrugInteractions']");
    private final By headerLoc = By.xpath("//*[contains(text(), 'Drug Drug Interactions List')]");

    public DrugDrugInteractionsPage navigateToDrugDrugInteractions() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Drug Drug Interactions: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/cdss-management/drugDrugInteractions");
    }
}
