...
public class AuditLogPage extends CommonToAllPage {
    ...
    private final By headerLoc = By.xpath("//div[contains(@class, 'panel-header') and contains(., 'Audit Log')]");
    ...
    public AuditLogPage navigateToAuditLog() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Could not click Audit Log: " + ex.getMessage());
                try {
                    WebElement link = getDriver().findElement(linkLoc);
                    ((JavascriptExecutor) getDriver()).executeScript("arguments[0].click();", link);
                } catch (Exception e2) {}
    ...
    public boolean isPageLoaded() {
        ...
        return currentUrl.contains("/audit-log");
    }
}
